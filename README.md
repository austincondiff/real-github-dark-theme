...
1. Go to [VS Marketplace](https://marketplace.visualstudio.com/items?itemName=ergenekonyigit.real-github-dark-theme)
...
1. Clone and open this [repo](https://github.com/ergenekonyigit/real-github-dark-theme) in VS Code
...
5. Make changes to the [`/src/theme.js`](https://github.com/ergenekonyigit/real-github-dark-theme/blob/master/src/theme.js) file.
...
3. Update [CHANGELOG.md](https://github.com/ergenekonyigit/real-github-dark-theme/blob/master/CHANGELOG.md) + commit the changes.
...
5. Push the commits and make a [new release](https://github.com/ergenekonyigit/real-github-dark-theme/releases/new).
